...
// Fri Jan 24 21:42:58 2014 by ROOT version 5.34/07
// from TTree EventTree/Event data
// found on file: root://eoscms//eos/cms/store/group/phys_egamma/cmkuo/job_summer12_WAA_ISR.root
//////////////////////////////////////////////////////////

#ifndef Signal_TreeLoop_Plotter_h
#define Signal_TreeLoop_Plotter_h
...
class Signal_TreeLoop_Plotter : public TSelector {
public :
   ...
   Signal_TreeLoop_Plotter(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~Signal_TreeLoop_Plotter() { }
   ...
   ClassDef(Signal_TreeLoop_Plotter,0);
};

#endif

#ifdef Signal_TreeLoop_Plotter_cxx
void Signal_TreeLoop_Plotter::Init(TTree *tree)
{
...
Bool_t Signal_TreeLoop_Plotter::Notify()
{
...
#endif // #ifdef Signal_TreeLoop_Plotter_cxx
